---
id: course-assessments-hardware
title: Course Assessments and Hardware Requirements
---

# Course Assessments and Hardware Requirements

## Assessments

The Physical AI & Humanoid Robotics course includes four key assessments designed to evaluate students' understanding and practical implementation of the concepts covered throughout the quarter.

### 1. ROS 2 Package Development Project

**Objective:** Demonstrate proficiency in ROS 2 concepts, node development, and system integration.

**Requirements:**
- Create a ROS 2 package for a humanoid robot controller
- Implement at least 3 nodes: sensor processor, controller, and state publisher
- Use topics, services, and actions appropriately
- Include launch files for system orchestration
...
- Documentation including architecture diagram
- Video demonstration of the system in operation
- Performance metrics and analysis

**Evaluation Criteria:**
- Code quality and adherence to ROS 2 conventions
- System functionality and robustness
...
**Objective:** Develop and implement a complete simulation environment for a humanoid robot.

**Requirements:**
- Create a URDF model of a humanoid robot
- Implement realistic physics properties
- Simulate multiple sensor types (camera, LiDAR, IMU, force/torque)
- Create a custom Gazebo world for testing
- Implement sensor noise models to reflect real-world conditions
- Demonstrate robot navigation and basic manipulation in simulation

**Deliverables:**
- Complete URDF and SDF files
- Gazebo world files
- Configuration files for sensors
- Video demonstration of simulation
- Analysis of simulation-to-reality transfer challenges

**Evaluation Criteria:**
- Accuracy of physical model
- Realism of sensor simulation
- Quality of environment design
- Performance in simulation
- Understanding of sim-to-real challenges

### 3. Isaac-Based Perception Pipeline

**Objective:** Implement an AI-powered perception system using NVIDIA Isaac tools.

**Requirements:**
- Design and implement a perception pipeline using Isaac ROS packages
- Integrate computer vision models for object detection/segmentation
- Implement visual SLAM for localization
- Optimize pipeline for real-time performance on NVIDIA hardware
- Evaluate perception accuracy and performance metrics
- Integrate perception outputs with navigation system

**Deliverables:**
- Complete perception pipeline implementation
- Performance benchmarking results
- Evaluation of perception accuracy
- Video demonstration of perception in action
- Analysis of computational requirements

**Evaluation Criteria:**
- Accuracy of perception outputs
- Real-time performance
- Efficient use of Isaac ROS packages
- Integration with navigation
- Computational efficiency

### 4. Capstone: Simulated Humanoid Robot with Conversational AI

**Objective:** Integrate all course concepts into a complete humanoid robot system with natural language interaction.

**Requirements:**
- Combine ROS 2, simulation, and perception components
- Implement conversational AI with speech recognition and synthesis
- Enable the robot to understand and execute voice commands
- Implement safe navigation and manipulation behaviors
- Demonstrate multi-modal interaction (speech, vision, action)
- Create a polished user experience

**Deliverables:**
- Complete integrated system
- Demonstration video showing all capabilities
...
- Quality of conversational interface
- Safety and reliability of robot behaviors
